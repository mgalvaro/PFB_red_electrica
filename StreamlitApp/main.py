...
def run_query():
    ...
    if demanda_data and generacion_data and intercambios_data:
        return demanda_data, generacion_data, intercambios_data
    else:
...
def main():
    ...
    df_demanda, df_generacion, df_intercambios = run_query()
